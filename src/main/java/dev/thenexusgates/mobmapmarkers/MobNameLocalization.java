...
final class MobNameLocalization {
    ...
    static String resolveDisplayName(String translationKey, String fallbackDisplayName, String language) {
    ...
    static String buildAssetLocaleKey(String translationKey, String language, String localizedDisplayName) {
        if (translationKey != null && !translationKey.isBlank()) {
    ...
    static String formatDistanceMeters(int distance, String language) {
