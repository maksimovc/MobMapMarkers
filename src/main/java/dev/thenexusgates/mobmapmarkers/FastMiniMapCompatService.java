...
final class FastMiniMapCompatService {
    ...
    FastMiniMapCompatService(MobMarkerManager manager, MobMarkerVisibilityService visibilityService) {
    ...
    void register() {
        ...
        LOGGER.info("[MobMapMarkers] FastMiniMap mob overlay registered.");
    }

    void unregister() {
        FastMiniMapMobLayerApi.setProvider(null);
        LOGGER.info("[MobMapMarkers] FastMiniMap mob overlay unregistered.");
    }
