...
public final class MobMapImageProcessor {
    ...
    public static byte[] createFallbackMarkerPng(int size, int contentScalePercent) {
        try {
    ...
    public static byte[] createFallbackMarkerPng(int size) {
     ...
     */
    public static byte[] createMinimapBadgePng(String roleName, String displayName, int size) {
        try {
            int iconSize = Math.max(16, size);
            BufferedImage out = new BufferedImage(iconSize, iconSize, BufferedImage.TYPE_INT_ARGB);
            Graphics2D g = out.createGraphics();
    ...
    public static byte[] createMobMarkerPng(String roleName, String displayName, int size) {
        try {
    ...
    public static byte[] createMobPortraitMarkerPng(byte[] rawPng, int size, boolean facingRight, int contentScalePercent) {
